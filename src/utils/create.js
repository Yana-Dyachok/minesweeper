...
const linkItemThree = document.createElement("a");
ulist.setAttribute("class", "header-list");
linkItemOne.setAttribute("class", "nav-link-item");
linkItemOne.textContent = "Game";
linkItemTwo.setAttribute("class", "nav-link-item");
linkItemTwo.textContent = "Options";
linkItemThree.setAttribute("class", "nav-link-item");
linkItemThree.textContent = "Help";
menuBurger.appendChild(spanBurger);
listItemOne.appendChild(linkItemOne);
listItemTwo.appendChild(linkItemTwo);
listItemThree.appendChild(linkItemThree);
